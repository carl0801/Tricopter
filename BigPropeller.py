...
try:
    while Hover:
        ...
        p.setJointMotorControl2(drone_id, wing_joints[-1], p.POSITION_CONTROL, targetPosition=tilt_angle)
    ...
    while not Hover:
        ...
        vertical_force1=output1*3
        vertical_force2=output2*3
        vertical_force3=output3*3

        motor_forces = [vertical_force1, vertical_force2, vertical_force3] 
        # rotate all wings to 45 degrees
        ...
        clockwise = 1
        counterclockwise = -1
        torques = [output1*torque_scale*clockwise, output2*torque_scale*clockwise, output3*torque_scale*clockwise]
